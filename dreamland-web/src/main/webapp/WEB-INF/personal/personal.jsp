    ...
    <div style="margin-left: 400px;color: white">
        <div class="foot-nav clearfix">
            ...
            <div class="foot-nav-col">
                ...
                <ul style="color: white">
                    <li>
                        <a href="http://www.dreamland.yang" onMouseOut="hideImg()"  onmouseover="showImg()" style="color: white">
                            微信
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 20px;margin-left: 400px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 100px">
                ...
                <p>
                    ...
                    <span style="color: white">邮箱：xxx@dreamland.yang</span>
                </p>
                <p style="margin-top: 8px;color: white;font-size: 12px">&copy;www.dreamland.yang 梦境网版权所有</p>
            </div>
        </div>
    </div>
</div>
